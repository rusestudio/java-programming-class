	...
	protected void paintComponent(Graphics g) {
       ...
       //draw shape
        for (Shape shape : shapes) {
            ...
            switch (shape.type) {
                case 1: //draw rec
                    g2d.fillRect(shape.x - 25, shape.y - 25, 50, 50); //-25 is offset to make when user click it draw from center
                    break;
                case 2: //draw circe
                    g2d.fillOval(shape.x, shape.y, 50, 50);// if no offset it will draw from top-left
                    break;
                case 3: //draw tri
