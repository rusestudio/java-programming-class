...
public class midtermq4 {
    ...
    int close = totalVoters - 1; // Subtract 1 for the ending flag value (-1)
    ...
    // Output first place candidates       
    System.out.print("1st place candidate(s): ");
    for (int i = 0; i < votes.length; i++) {          
    	if (votes[i] == maxVotes) {
